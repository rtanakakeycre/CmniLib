...
namespace CmniLib
{
    ...
    public class PipeCmni
    {
        ...
        // 全プロセス一覧
        public static sPRS m_sPrs;
        public static dgPRS_LIST_UPD m_dgPrsListUpd;
        public static dgRCV_DATA m_dgRcvData;
        public static List<sOTH_PRS> m_asRcgPrs;           // 認識プロセスリスト

        // シリアルポートリスト
        [XmlIgnore]
        public static List<sSRI_PORT> m_asPort;
        ...
        private static void RcvSerData(object sender, SerialDataReceivedEventArgs e)
        {
            try
            {
        ...
        // パイプを追加
        public static void AddCmniPort(string txCmniPort1, dgRCV_DATA dgRcvData1, sPORT_SETS sPortSets1)
        {
            m_asCmniPort.Add(new sCMNI_PORT(txCmniPort1, dgRcvData1, sPortSets1));
        }

        // パイプを取得
        public static sCMNI_PORT GetCmniPort(string txCmniPort1)
        {
        ...
        // 通信管理終了
        public static void EndCmniCtrl()
        {
            // プロセスに認識要求を送信
        ...
        // パイプ名取得
        public static string GetPipeName(string txId1)
        {
            return($"{NPSS_PRFX}_{txId1}");
        }

        // パイプ通信開始
        public static bool StaCmniPort(sCMNI_PORT sCmniPort1)
        {
            bool flCone1 = false;
        ...
        // パイプ通信終了
        public static bool EndCmniPort(sCMNI_PORT sCmniPort1)
        {
            bool flCone1 = false;
            switch (sCmniPort1.m_sPortSets.m_nbPortType)
            {
        ...
        // シリアルポート取得
        public static sSRI_PORT GetSerPort(string txName1)
        {
            return (m_asPort.Where(sPort1 => sPort1.m_txName == txName1).FirstOrDefault());
        }

        // シリアルポート取得
        public static sSRI_PORT GetSerPort(SerialPort sSp1)
        {
            return (m_asPort.Where(sPort1 => sPort1.m_sPort == sSp1).FirstOrDefault());
        }

        // 通信ポートへコマンドを送信
        public static void SendCmdToCmniPort(string txCmniPort1, byte[] adtCmd1)
        {
        ...
        // パイプにコマンドを送信
        private static string SendCmdToPipe(sCMNI_PIPE sPipe1, byte[] adtCmd1)
        {
            string txRes1 = "";
        ...
        // シリアル通信開始
        public static bool SriOn(sPORT_SETS sPortSets1)
        {
            bool flCone1 = false;
            try
            {
        ...
        // シリアル通信を終了
        public static void SriOff(sPORT_SETS sPortSets1)
        {
            sSRI_PORT sPort1 = GetSerPort(sPortSets1.m_txSerPort);
            sPort1.m_ctRef--;
            if (sPort1.m_ctRef <= 0)
        ...
        // パイプのプロセスが有効か？
        public static void ChgEfcPipePrs(sCMNI_PIPE sPipe1)
        {
        ...
        // パイプ通信開始
        public static bool PipeOn(sPORT_SETS sPortSets1)
        {
            bool flCone1 = false;
            try
            {
        ...
        // パイプ通信終了
        public static bool PipeOff(sPORT_SETS sPortSets1)
        {
            bool flCone1 = true;
            try
            {
        ...
        private static async Task ServerTask(Func<string, string> dgSvrRcv)
        {
            while (true)
            {
        ...
        // Contentの文字列を逆順にする処理
        private static string ServerProcess(string txData1)
        {
            string txRes1 = "";
        ...
        // パイプ受信タスク
        private static async Task PipeRcvTask(CancellationToken sCt1, dgRCV_DATA dgDataRcv1, string txPipeName1)
        {
            while (true)
            {
        ...
        // クライアント
        private static string Client(string txId1, string txReq1)
        {
            string txRes1 = "";
        ...
        private static string ClientProcess(string txId1, string txData1)
        {
            string txRes1 = "";
        ...
        // IDからプロセスを取得
        public static sOTH_PRS GetRcgPrsFromId(string txId1)
        {
            sOTH_PRS sPrs2 = null;
        ...
        // プロセスリストに要求を送信
        public static void SendReqToPrsList(string txReq1)
        {
        ...
        // プロセスに要求を送信
        public static string SendReqToPrs(string txReq1, string txId1)
        {
            // クライアント
        ...
        // プロセスリストを取得
        public static List<sOTH_PRS> GetPrsList()
        {
        ...
        // 認識プロセスリストを取得
        public static List<sOTH_PRS> GetRcgPrsList()
        {
            List<sOTH_PRS> asPrs1 = new List<sOTH_PRS>();
            foreach(sOTH_PRS sPrs1 in m_asRcgPrs)
            {
        ...
        // 認識プロセスリストに要求を送信
        public static void SendReqToRcgPrsList(string txReq1)
        {
        ...
        // 認識パイプリストを取得
        public static List<sPIPE> GetRcgPipeList()
        {
        ...
        public static sCMNI_PIPE[] GetRcgCmniPipeList()
        {
